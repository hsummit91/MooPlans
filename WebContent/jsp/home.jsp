...
<body class="cbp-spmenu-push" onload="getUserDetails()">
	...
	<%-- <h3>Username :<%=userName%>, Login successful. Your Session ID=<%=sessionID%></h3> --%>
	<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left"
		id="cbp-spmenu-s1">
	<div id="sideProfile" align="center"></div>
	<h3>
		<span id="firstName">Omkar Kulkarni</span>
	</h3>
	<h4>
		Moo Points: <span id="mooPoints"> 175 </span>
	</h4>
	...
	<div class="container">
		<div
			style="cursor: pointer; font-size: 50px; z-index: 1010; margin: 5px; width: 30px; height: 30px;"
			id="showLeftPush">
