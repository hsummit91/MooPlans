...
<title>Moo Home</title>
	...
	<body class="cbp-spmenu-push" onload="getUserDetails()">
		<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
			...
			<a href="#" id="orders" onclick="displayPages(this)">Place an Order</a>
		...
		<div class="container">
			...
			<div class="zooming" id="expandMenu" onclick="toggleArrows()" style="width: 30px;height: 30px;"><i class="fa fa-angle-right"></i></div>
			</div>
			<div style="text-align: center;">Welcome to Moo Plans!</div>
			
			<div id="other" style="width: auto;height: 580px;"> <iframe width="100%" height="100%" frameborder="0" ></iframe> </div>
		</div>
